  ...
  const renderedHtml = useMemo(() => {
    if (activeMailbox === 'no-reply@zebrold.de') {
      return generateNoReplyEmailHtml({
        recipientName: noReplyForm.toName || 'Admin Desk',
        recipientEmail: noReplyForm.toEmail || 'admin@zebrold.de',
        title: noReplyForm.title || 'Admin Password Reset Security Verification',
        otpCode: noReplyForm.otpCode || '584920',
        referenceId: noReplyForm.referenceId || 'SEC-OTP-98214',
        alertType: noReplyForm.alertType || 'PASSWORD RESET OTP',
        message: noReplyForm.message || 'A security verification request was initiated for your Zebrold Group Admin account. Enter the 6-digit verification code below to authorize the password change.',
        actionUrl: noReplyForm.actionUrl || '',
        actionText: noReplyForm.actionText || 'Open Security Console',
        expiresIn: noReplyForm.expiresIn || '15 minutes',
      });
    } else if (activeMailbox === 'talent.acquisition@zebrold.de') {
      return generateTalentEmailHtml({
        candidateName: talentForm.candidateName || 'Alex Morgan',
        candidateEmail: talentForm.candidateEmail || 'alex.morgan@example.com',
        jobTitle: talentForm.jobTitle || 'Senior Full-Stack Software Engineer',
        department: talentForm.department || 'Engineering & Technology',
        location: talentForm.location || 'Frankfurt am Main / Hybrid',
        status: talentForm.status || 'INTERVIEW',
        customMessage: talentForm.customMessage || 'We were highly impressed by your experience and portfolio. Our hiring committee would like to invite you for a 45-minute technical and architecture discussion with our engineering leads.',
        interviewDetails: talentForm.hasInterviewDetails ? {
          date: talentForm.interviewDate || 'Thursday, August 14, 2026',
          time: talentForm.interviewTime || '14:30',
          timezone: talentForm.interviewTimezone || 'CET (Frankfurt)',
          format: talentForm.interviewFormat || 'Video Conference (Google Meet)',
          interviewer: talentForm.interviewer || 'Dr. Marcus Vance & Sarah Lin',
          link: talentForm.interviewLink || 'https://meet.google.com/zbr-tech-eval',
        } : null,
        offerDetails: talentForm.hasOfferDetails ? {
          role: talentForm.offerRole || 'Senior Full-Stack Software Engineer',
          startDate: talentForm.offerStartDate || 'October 1, 2026',
          deadline: talentForm.offerDeadline || 'August 25, 2026',
        } : null,
        actionUrl: talentForm.actionUrl || 'https://meet.google.com/zbr-tech-eval',
        actionText: talentForm.actionText || 'Confirm Interview Slot',
      });
    } else {
      return generateInfoEmailHtml({
        recipientName: infoForm.recipientName || 'Herr Dietrich Weber',
        recipientEmail: infoForm.recipientEmail || 'partner@meridian-capital.de',
        company: infoForm.company || 'Meridian Capital Partners',
        subject: infoForm.subject || 'Response to Institutional Partnership Inquiry — Zebrold Group',
        memoRef: infoForm.memoRef || 'ZBR-INQ-2026-4402',
        department: infoForm.department || 'Corporate Relations & Strategic Partnerships',
        messageBody: infoForm.messageBody || 'Thank you for your correspondence regarding prospective strategic co-investment and syndicate opportunities with Zebrold Group. Our Executive Committee has reviewed your memorandum and welcomes the opportunity for an introductory executive discussion.',
        highlightBox: infoForm.highlightBox || 'An executive liaison from our Frankfurt Global HQ will coordinate the preliminary agenda and digital briefing room.',
        actionUrl: infoForm.actionUrl || 'https://www.zebrold.de',
        actionText: infoForm.actionText || 'Visit Executive Portal',
        signatoryName: infoForm.signatoryName || 'Executive Secretariat',
        signatoryTitle: infoForm.signatoryTitle || 'Zebrold Group Corporate Relations',
      });
    }
